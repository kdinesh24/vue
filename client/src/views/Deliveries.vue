    ...
    <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="mt-2 text-gray-600">Track your delivery status</p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card>
          <CardContent class="p-6">
            ...
            <p class="text-xs text-muted-foreground mt-1">Total Deliveries</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent class="p-6">
            ...
            <p class="text-xs text-muted-foreground mt-1">Delivered</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent class="p-6">
            ...
            <p class="text-xs text-muted-foreground mt-1">In Transit</p>
          </CardContent>
        </Card>
          ...
          <div v-else>
            <Table>
              ...
              <TableBody>
                ...
                <TableRow v-for="delivery in deliveries" :key="delivery.deliveryId">
                  ...
                  <TableCell>{{ delivery.deliveredBy || 'N/A' }}</TableCell>
...
const stats = computed(() => {
  ...
  const inTransit = deliveries.value.filter(d => d.status === 'In Transit').length
